...
import type { SignupFormTypes, SignupMutationTypes } from '../../types/types.js';
import { GET_ALL_USERS, GET_USER, GET_USER_EMAIL } from '../utils/graphql/queries.ts';
...
const Signup = () => {
  ...
  const [formState, setFormState] = useState<SignupFormTypes>({
    firstName: '', lastName: '', username: '', email: '', password: '', confirmed: '',
  });
  //--------------------------------------------//
  const [addUser, { data, loading, error }] = useMutation<SignupMutationTypes>(ADD_USER);
  //--------------------------------------------//
